        ...
        action = ''
          ...
          if [ "$AC_STATUS" -eq 1 ]; then
              ...
              DISPLAY=:0 DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/1000/bus \
                ${pkgs.libnotify}/bin/notify-send -u low -t 2000 "⚡ AC Connected" "Profile: Balanced • Brightness: 80%"
              ...
              # Send notification to user
              DISPLAY=:0 DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/1000/bus \
                ${pkgs.libnotify}/bin/notify-send -u low -t 2000 "🔋 Battery Mode" "Profile: Power Saver • Brightness: 40%"
